...
import com.niit.service.client.entity.Constants;
import com.niit.service.client.entity.Result;
import com.niit.service.client.handler.*;
import com.niit.service.client.support.FileClientPipelineFactory;
...
public class FileClient {
	 ...
	 */
	@PostMapping("/upload")
	public  static String uploadFile(@RequestParam("files") MultipartFile files, @RequestParam String fileName,
							  @RequestParam boolean thumbMark) {

		String filesOriginalFilenameName = files.getOriginalFilename();
		String fileTempPath = "D:\\tep";//config文件
		File file = new File(fileTempPath+filesOriginalFilenameName);
