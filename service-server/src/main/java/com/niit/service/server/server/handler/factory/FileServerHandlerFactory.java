 ...
 * 
 */
package com.niit.service.server.server.handler.factory;


import com.niit.service.server.Account;
import com.niit.service.server.Result;
import com.niit.service.server.server.FileServerContainer;
import com.niit.service.server.server.handler.CreateThumbPictureServerHandler;
import com.niit.service.server.server.handler.DeleteFileServerHandler;
import com.niit.service.server.server.handler.ReplaceFileServerHandler;
import com.niit.service.server.server.handler.UploadFileServerHandler;
import com.niit.service.server.server.handler.processor.FileServerProcessor;
import com.niit.service.server.server.parse.RequestParam;
import com.niit.service.server.server.utils.common.JSONUtil;
import com.niit.service.server.server.utils.enumobj.EnumFileAction;
